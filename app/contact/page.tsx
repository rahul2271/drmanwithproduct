    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          {[
            { icon: Phone, title: "Phone", info: "+91 (XXX) XXX-XXXX", desc: "Available Mon-Sat, 10 AM - 6 PM" },
            {
              icon: Mail,
              title: "Email",
              info: "contact@drmanpreetayurveda.com",
              desc: "Response within 24 hours",
            },
            { icon: MapPin, title: "Location", info: "New Delhi, India", desc: "Direct & online consultations" },
            { icon: Clock, title: "Hours", info: "Mon-Sat: 10 AM - 6 PM", desc: "Sunday: By appointment" },
          ].map((item, i) => (
            <Card key={i} className="p-6 border border-border bg-card text-center hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 mx-auto rounded-lg bg-primary/10 flex items-center justify-center mb-4">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-primary/5">
        <div className="max-w-7xl mx-auto">
          <div className="flex gap-4 mb-8 border-b border-border">
            {[
              { id: "contact", icon: MessageSquare, label: "Send Message" },
              { id: "booking", icon: Clock, label: "Book Appointment" },
            ].map((tab) => (
              <button
                key={tab.id}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      placeholder="Tell us about your skin concern..."
                      className="w-full px-4 py-2 rounded-lg border border-border bg-background focus:ring-2 focus:ring-primary resize-none"
                    />
                  </div>
